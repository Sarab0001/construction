...
import ChairmanImage from "@/app/Assets/Chairman.png";

const ChairmanLeadership: React.FC = () => {
  return (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-left">
          <h3 className="text-3xl font-bold mb-8 ">
            Chairman Leadership: Guiding the Path to Success
          </h3>
...
export default ChairmanLeadership;
